...
знания1.добавить(new Эквивалентность(new И(АЛжец, БРыцарь), БРыцарь))
...
знания3.добавить(new Эквивалентность(new И(БЛжец, ВРыцарь), АРыцарь))

знания3.добавить(new Эквивалентность(БЛжец,new Не(БРыцарь)))
знания3.добавить(new Эквивалентность(new И(ВЛжец, АЛжец), БРыцарь))

знания3.добавить(new Эквивалентность(ВРыцарь, new Не(ВЛжец)))
знания3.добавить(new Эквивалентность(new И(АРыцарь, БРыцарь), ВЛжец))
